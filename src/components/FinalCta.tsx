  ...
  return (
    <section className="relative overflow-hidden py-28 sm:py-36 lg:py-44">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-full aspect-square w-[150vw] max-w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.10),transparent_62%)] blur-3xl" />
        <svg
          viewBox="0 0 1000 1000"
          className="absolute left-1/2 top-full aspect-square w-[150vw] max-w-[900px] -translate-x-1/2 -translate-y-1/2"
        >
          {[240, 340, 440].map((r) => (
            <circle
              key={r}
